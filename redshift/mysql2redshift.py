# Ripped off from https://github.com/lanyrd/mysql-postgresql-converter/blob/master/db_converter.py
...
def parse(input_filename, output_filename):
    ...
    for i, line in enumerate(input_fh):
        ...
        line = line.replace("`", '"').replace('b\'0\'', '0').replace('b\'1\'', '1').replace('0000-00-00 00:00:00', '1970-01-01 00:00:00')
